...
// Use yText to select the group.
var yText = d3.select(".yText");

// Put the transform attr in a function
...
function visualize(theData) {
  ...
  d3.selectAll(".aText").on("click", function() {
    ...
    // Only want run  on inactive labels.
    ...
    if (self.classed("inactive")) {
      ...
      if (axis === "x") {
        ...
        d3.selectAll("circle").each(function() {
          //  Set a transition for each state circle between old and new position 
